...
[We've previously covered goroutines in the first concurrency chapter](concorrencia.md) which let us write safe concurrent code so why would you use locks?  
