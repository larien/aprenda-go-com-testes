...
Agora que temos um caminho feliz, queremos fazer um cenário mais realista onde a `Store` não consegue finalizar o `Fetch` antes que o usuário cancele a requisição.
