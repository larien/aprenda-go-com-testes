...
// Package websocket implementa the WebSocket protocol defined in RFC 6455.
//
// Overview
//
...
//          return
//      }
//      ... Use conn to send and receive mensagens.
//  }
//
// Call the connection's WriteMessage and ReadMessage methods to send and
// receive mensagens as a slice of bytes. This snippet of code shows how to echo
...
// shows how to echo mensagens using the NextWriter and NextReader methods:
//
//  for {
...
// binary mensagens is left to the application.
//
...
//
// It is the application's responsibility to ensure that text mensagens are
...
// in mensagens from the peer, then the application should start a goroutine to
...
//
// Per message compression of mensagens written to a connection can be enabled
// or disabled by calling the corresponding Conn method:
//
//  conn.EnableWriteCompression(false)
//
// Currently this package does not support compression with "context takeover".
// This means that mensagens must be compressed and decompressed in isolation,
